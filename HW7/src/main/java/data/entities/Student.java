...
@NamedQueries({
    ...
    @NamedQuery(name = Student.GET_ALL_STUDENTS_BY_COURSE, query = "SELECT s FROM Student s WHERE s.course = :course"),
...
public class Student {
    ...
    public static final String GET_ALL_STUDENTS_BY_COURSE = "Student.getAllStudentsByCourse";
